...
#  (i.e. A[0] ≤ A[1] ≤ ... ≤ A[N−1]) is given. The leader of this array is the value
#  that occurs in more than half of the elements of A.
# 
# You are given an implementation of a function:
#
# def solution(a)
# that, given a non-empty zero-indexed array A consisting of N integers, sorted in a
# non-decreasing order, returns the leader of array A. The function should return −1
# if array A does not contain a leader.
